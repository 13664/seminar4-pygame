...
clock = pygame.time.Clock()  # to control how fast frames get change per second
...
cat_surface = pygame.image.load('graphics/man2.png')
cat_x_pos= 0
# to add a new image
man3_surface = pygame.image.load('graphics/man.png')
man3_x_pos = 0
...
while True:
    ...
    screen.blit(cat_surface, (cat_x_pos, 402))
    screen.blit(man3_surface,(man3_x_pos, 304))
